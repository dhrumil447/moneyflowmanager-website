    ...
    <section id="download" className="py-20 md:py-28">
      <div className="container-px mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-primary p-10 sm:p-14 lg:p-20 text-center shadow-glow">
          <div aria-hidden className="absolute -top-20 -left-20 h-72 w-72 rounded-full bg-primary-foreground/10 blur-3xl" />
          <div aria-hidden className="absolute -bottom-20 -right-20 h-72 w-72 rounded-full bg-primary-foreground/10 blur-3xl" />

          <div className="relative">
            <img src={logo} alt="MoneyFlow Manager" className="h-20 w-20 mx-auto mb-6 drop-shadow-2xl animate-float" width={80} height={80} loading="lazy" />
            ...
            <p className="mt-5 text-lg sm:text-xl text-primary-foreground/85 max-w-2xl mx-auto">
              Join 50,000+ people building healthier financial habits with MoneyFlow Manager.
            </p>

            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
              <Button asChild size="lg" className="bg-foreground text-background hover:bg-foreground/90 h-14 px-7 text-base">
              ...
              <Button asChild size="lg" className="bg-background text-foreground hover:bg-background/90 h-14 px-7 text-base">
                <a href="#" aria-label="Get it on Google Play">
                  <Play className="mr-2 h-5 w-5 fill-foreground" />
                  <span className="text-left leading-tight">
