...
const insights = [
  { icon: PieChart, title: "Pie chart visuals", text: "Where your money really goes." },
      ...
      <div className="container-px mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 flex justify-center">
            <PhoneMockup variant="analytics" className="animate-float" />
          </div>
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-5 text-lg text-muted-foreground">
              Beautiful visualizations turn numbers into stories. Spot patterns,
              fix bad habits, and celebrate progress.
            </p>
